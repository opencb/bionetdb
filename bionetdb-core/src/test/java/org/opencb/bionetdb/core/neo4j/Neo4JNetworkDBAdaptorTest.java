...
//        }
        ...
        dbAdaptor.xQuery(family1, phenotype1, "dominant", Arrays.asList("CADM1", "BRCA1", "BRCA2", "TP53", "BCL2", "ADSL",
                "CTBP2P1", "BMPR2"), Arrays.asList("Hepatitis", "Anxiety"), Arrays.asList("AFR", "EUROPE"),0.99,
                Arrays.asList("variant", "intron_variant"), true, false);
    }
}
