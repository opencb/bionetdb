...
//        RNA__MIRNA("RNA__MIRNA"),
        ...
        TRANSCRIPT__PROTEIN("TRANSCRIPT__PROTEIN"),
        ...
        GENE__TRANSCRIPT("GENE__TRANSCRIPT"),
        GENE__DRUG("GENE__DRUG"),
        GENE__DISEASE("GENE__DISEASE"),
        GENE__CONSTRAINT("GENE__CONSTRAINT"),
        TRANSCRIPT__EXON("TRANSCRIPT__EXON"),
        TRANSCRIPT__TFBS("TRANSCRIPT__TFBS"),
        TRANSCRIPT__CONSTRAINT("TRANSCRIPT__CONSTRAINT"),
        TRANSCRIPT__FEATURE_ONTOLOGY_TERM_ANNOTATION("TRANSCRIPT__FEATURE_ONTOLOGY_TERM_ANNOTATION"),
        FEATURE_ONTOLOGY_TERM_ANNOTATION__ANNOTATION_EVIDENCE("FEATURE_ONTOLOGY_TERM_ANNOTATION__ANNOTATION_EVIDENCE"),
        ...
        PROTEIN__PROTEIN_KEYWORD("PROTEIN__PROTEIN_KEYWORD"),
